...
function issueCertificate(membershipnumber) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (existingrecordByMembershipNumber.status !=
            parameters_1.CertificateRegisterStatus.Approved)
            throw "Record Not in Approval Stage";
        yield CertificateRegister.findOneAndUpdate({ membershipnumber: membershipnumber }, { status: parameters_1.CertificateRegisterStatus.Issued });
    });
}
